                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <c:forEach items="${lstSensors}" var="sensor">
                                    <tr>
                                        ...
                                        <td><input type ="button" onclick="location.href='http://localhost:9090/WeatherAdminDataViewer/VisualiseAllDataFromOneSensor?idSensor=${sensor.id}';" value="Voir les mesures" />

                                            <%--<a href="http://localhost:9090/WeatherAdminDataViewer/VisualiseAllDataFromOneSensor?idSensor=${sensor.id}">Data</a></td>--%>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
