...
<html lang="fr">
<head>
    <title>Alerte du capteur ${sensorName}</title>
        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Historique des alertes du capteur ${sensorName}</h2>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatableAlerte" class="table table-striped table-bordered">
                                <thead>
                                <tr>
